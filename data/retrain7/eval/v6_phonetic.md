# Eval: `models/phonikud_yi_v6/best`

Test set: `data/retrain3/test.jsonl` -- 409 rows (episode 100313, held out of train and val).
Inference 11.3s. Letter-unsafe rows: 0. Token-misaligned rows: 0.
...
| `char_acc` | 75.66 |
| `marked_char_acc` | 75.96 |
| `dagesh_acc` | 96.96 |
| `rafe_acc` | 98.93 |
| `shin_acc` | 99.1 |
| `ceiling_char_acc` | 91.04 |
| `char_headroom_to_ceiling` | 15.38 |

**Ceiling 91.04%** -- see the section below. This model is at 83.11% of it.

## 2. Word-level exact pointing

48.82% of 2,997 supervised words get *every* Hebrew character exactly right.

Ceiling is 77.04%, so this is 63.37% of what is reachable (28.22 points of headroom).
...
| `vs_gold_all` | 4,845 | 90.84% |
| `vs_gold_fallback` | 21 | 95.24% |
| `vs_gold_lexicon` | 3,183 | 99.94% |
| `vs_gold_rule` | 1,641 | 73.13% |
...
char accuracy by at most 15.38 points and word-exact
by at most 28.22 from here.
...
- gold: הַיינְט קֶען מֶען זאָגן בסייעתא דִּשְׁמַיָּא מיט דֶעם שֶׁעפֶּערְס הִילְף אַז מֶען האַלט שוין אַןעהאַלטן צייט דִּינְסְטָאָג בַּיינַאכט לְכָבוֹד שַׁבַּת רֹאשׁ חוֹדֶשׁ אֲדָר.
  pred: הַייַנְט קֶען מֶען זאָגְן בִּסְיַיְעָתָא דִּשְׁמַיּאָ מִיט דֶעם שֶׁעפֶֿערְס הִילְף אַז מֶען הַאַלְט שׁוֹין אַןֶעהאַלְטְן צַייַט דִינְסְטָאָג בַּייַנאַכְט לִכְבוֹד שַׁבָּת רֹאשׁ חוֹדֶשׁ אדָר.
