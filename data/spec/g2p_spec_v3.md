...
| וי | ɔj / oʊ | ɔj | oʊ list (û-class 54 only): ous, arous, houz, mouz, moul, touznt, lout, ouf, arouf, drousn, krout, shtount, hout, boukh, pouer. **Not** oukh — אויך is ɔjx (44). **טויב** is a homograph: toʊb dove vs tɔjb deaf — keep both; no context model. English *ou/ow* cousins are a diagnostic gut-check, not an inference lookup. |
